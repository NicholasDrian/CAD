...
public:
	...
	Mesh(const std::vector<glm::vec3>& positions, const std::vector<glm::vec3>& normals, const glm::vec4& color, const std::vector<unsigned>& indecies, unsigned id = Scene::GetNewID());
